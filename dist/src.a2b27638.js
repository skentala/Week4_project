      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          dataJson.forEach(function (data) {
            ...
            var divShowData = document.createElement("div");
            divShowData.setAttribute("class", "show-data");
            var imgShowImage = document.createElement("img");
            var divShowInfo = document.createElement("div");
            divShowInfo.setAttribute("class", "show-info");
            var h1ShowTitle = document.createElement("h1");
            if (data.show.image) {
